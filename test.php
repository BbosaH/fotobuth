...
$sql4="CREATE TABLE IF NOT EXISTS `message` (
  `id` int(30) NOT NULL,
...
$sql5="CREATE TABLE IF NOT EXISTS `myclass` (
  `id` int(11) NOT NULL,
...
$sql6 = "CREATE TABLE IF NOT EXISTS `school` (
  `id` int(10) NOT NULL,
  `name` varchar(100) NOT NULL,
...
$sql7 = "CREATE TABLE IF NOT EXISTS `status` (
  `id` int(10) NOT NULL,
  `name` varchar(30) NOT NULL,
  `remarks` text NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;";

$sql8 = "CREATE TABLE IF NOT EXISTS `strong_subject` (
  `id` int(30) NOT NULL,
  `subject_id` int(30) NOT NULL,
  `user_id` int(30) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=latin1;";

$sql9 = "CREATE TABLE IF NOT EXISTS `subject` (
  `id` int(11) NOT NULL,
  `name` varchar(100) NOT NULL,
...
$sql10 = "CREATE TABLE IF NOT EXISTS `subject_myclass` (
  `id` int(10) NOT NULL,
  `myclass_id` int(10) NOT NULL,
  `subject_id` int(10) NOT NULL
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=latin1;";

$sql11 = "CREATE TABLE IF NOT EXISTS `university` (
  `id` int(10) NOT NULL,
  `name` varchar(100) NOT NULL,
...
$sql12 = "CREATE TABLE IF NOT EXISTS `user` (
  `id` int(11) NOT NULL,
...
$sql13 = "CREATE TABLE IF NOT EXISTS `user_connection` (
  `id` int(10) NOT NULL,
